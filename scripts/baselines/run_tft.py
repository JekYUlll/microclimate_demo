...
def main() -> None:
    ...
    if args.config:
        ...
        args.epochs = int(tft_cfg.get("epochs", args.epochs))
        args.hidden_size = int(tft_cfg.get("d_model", args.hidden_size))
        args.num_heads = int(tft_cfg.get("nhead", args.num_heads))
        args.dropout = float(tft_cfg.get("dropout", args.dropout))
        if args.plot is None:
            args.plot = cfg["reports_dir"] / "figures" / "tft_baseline.png"
        if args.log_path is None:
            args.log_path = cfg["reports_dir"] / "tables" / "tft_baseline_log.txt"
    cfg = SeriesConfig(
        data_path=args.data,
